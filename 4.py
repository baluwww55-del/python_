...
# so we here printed name and it showing which data type it is printing in output .

# TYPED CONVERSIONS :
#simple code of typed conversions :
age = 33 
my_float = 39.5 # we have to assign a perfect variable like my_float like that if we assign float it will be error.
age_float = float(age)
print(age_float)
